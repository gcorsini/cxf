...
public class TomcatDestinationFactory implements HttpDestinationFactory {
    ...
    public AbstractHTTPDestination createDestination(EndpointInfo endpointInfo, Bus bus,
        ...
        TomcatHTTPServerEngineFactory serverEngineFactory = bus
            .getExtension(TomcatHTTPServerEngineFactory.class);
        return new TomcatHTTPDestination(bus, registry, endpointInfo, serverEngineFactory);
    }
