...
public class TomcatHTTPServerEngineFactoryHolder {
    ...
    private static final Logger LOG = LogUtils.getL7dLogger(TomcatHTTPServerEngineFactoryHolder.class);
    ...
    public TomcatHTTPServerEngineFactoryHolder() {
    }
    ...
    public void init() {
        try {
            ...
            TomcatHTTPServerEngineFactoryConfigType config
                = getJaxbObject(element,
                    TomcatHTTPServerEngineFactoryConfigType.class);
...
//                    rThreads.setWorkerIOThreads(threads.getThreadingParameters().getWorkerIOThreads());
            ...
            List<TomcatHTTPServerEngine> engineList = new ArrayList<>();
            for (TomcatHTTPServerEngineConfigType engine : config.getEngine()) {
