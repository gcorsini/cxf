...
public class TomcatServerEngineFactoryParser extends AbstractBPBeanDefinitionParser {
    ...
    public static final String TOMCAT_THREADING = "http://cxf.apache.org/configuration/parameterized-types";
    ...
    public Metadata parse(Element element, ParserContext context) {
        ...
        if (!StringUtils.isEmpty(getIdOrName(element))) {
            ...
            ef.setId("tomcat.engine.factory-holder-" + UUID.randomUUID().toString());
        }
        ef.setRuntimeClass(TomcatHTTPServerEngineFactoryHolder.class);

        // setup the HandlersMap property for the TomcatHTTPServerEngineFactoryHolder
        ...
        try {
            ...
            List<Element> engines = DOMUtils
                .getChildrenWithName(element, HTTPTomcatTransportNamespaceHandler.TOMCAT_TRANSPORT, "engine");
    ...
    protected Metadata parseEngineHandlers(List<Element> engines, ComponentMetadata enclosingComponent,
        ...
        for (Element engine : engines) {
            ...
            Element handlers = DOMUtils
                .getFirstChildWithName(engine, HTTPTomcatTransportNamespaceHandler.TOMCAT_TRANSPORT,
                                       "handlers");
            if (handlers != null) {
