...
import org.apache.cxf.transport.http_tomcat.blueprint.HTTPTomcatTransportNamespaceHandler;
...
public class HTTPTomcatTransportActivator
        ...
        try {
            BlueprintNameSpaceHandlerFactory nsHandlerFactory = new BlueprintNameSpaceHandlerFactory() {
                ...
                public Object createNamespaceHandler() {
                    return new HTTPTomcatTransportNamespaceHandler();
                }
            };
    ...
    public void updated(String pid, Dictionary<String, ?> properties)
        ...
        try {
            ...
            if (tls != null) {
                ...
                factory.createTomcatHTTPServerEngine(host, port, "http");
            }

            TomcatHTTPServerEngine e = factory.retrieveTomcatHTTPServerEngine(port);
    ...
    private void configure(TomcatHTTPServerEngine e, Dictionary<String, ?> properties) {
