...
//        }
    ...
    protected Class<?> getBeanClass(Element arg0) {
        return SpringTomcatHTTPServerEngine.class;
    }

    @NoJSR250Annotations
    public static class SpringTomcatHTTPServerEngine extends TomcatHTTPServerEngine
        ...
        public SpringTomcatHTTPServerEngine(
                TomcatHTTPServerEngineFactory fac,
            Bus b,
            String host,
            int port) {
            super(host, port);
        ...
        public void setBus(Bus b) {
            ...
            if (null != bus && null == factory) {
                factory = bus.getExtension(TomcatHTTPServerEngineFactory.class);
            }
        }
